...
from news_analyzer.main import RadarNewsAnalyzer
...
class TestIntegration:
    ...
    @pytest.mark.asyncio
    def test_hotness_calculation(self):
        ...
        hotness = calculator.calculate_hotness(news_item)
    ...
    def test_full_pipeline(self):
        ...
        try:
            ...
            for news_item in news_data.news:
                hotness = analyzer.hotness_calculator.calculate_hotness(news_item)
