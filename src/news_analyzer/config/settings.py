...
load_dotenv()  # Добавь пробел здесь!
...
# Analysis thresholds
HOT_NEWS_THRESHOLD = float(os.getenv('HOT_NEWS_THRESHOLD', '0.7'))
WARM_NEWS_THRESHOLD = float(os.getenv('WARM_NEWS_THRESHOLD', '0.5'))
TOP_NEWS_COUNT = int(os.getenv('TOP_NEWS_COUNT', '10'))
...
# Volatility keywords with weights (для расчета материальности)
VOLATILITY_KEYWORDS = {
